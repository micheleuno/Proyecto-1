...
public class Grafico extends javax.swing.JFrame {
     ...
     */
    public Grafico(long vector[], int tipo, int nroBats, int nroIteraciones, int nroPartes, int nroCeldas, int maximoMaquinas, long bestFitness, String nroProblema) {
        initComponents();
        
        nFlores = nroBats;
        nIteraciones = nroIteraciones;
        nPartes = nroPartes;
        nCeldas = nroCeldas;
        maxMaquinas = maximoMaquinas;
        mejorFitness = bestFitness;
        nProblema = nroProblema;
        
        for(int i = 0; i < vector.length; i++){
            series.add((i+1), vector[i]);
        }
        
        if(tipo == 1) Graphic = ChartFactory.createXYLineChart("Problema  "+nProblema, "Bat", "Fitness", Datos, PlotOrientation.VERTICAL, false, true, true);
        if(tipo == 0) Graphic = ChartFactory.createXYLineChart("Problema  "+nProblema, "Iteración", "Fitness", Datos, PlotOrientation.VERTICAL, false, true, true);
    ...
    public Grafico(int vector[], MCDPData data, int numberIteration, int numberPoblation) {
        ...
        //System.out.println(nProblema+" Promedio: "+suma/30);
        //System.out.println(nProblema+" Mejor fitness: "+mejorFitness);
