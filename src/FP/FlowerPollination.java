...
public class FlowerPollination
{
	...
	/**
	 * Este es el procedimiento base de la metaheuristica, generalmente es el pseudoc贸digo que aparece
	 * en los papers.
	 */
	public void run()
	{
	...
	private void generateInitialPoblation()
	{
		for (int i = 0; i < numberPoblation; i++)
		{
			...
			// Estoy en el ciclo hasta generar una soluci贸n randomica que satisfaga las restricciones
	 ...
	 * Generar una soluci贸n vecina se denomina INTENSIFICACI脫N
	 */
	private void generateNeighbourSolution()
	{
		for (int i = 0; i < numberPoblation; i++)
		{
			...
			// Estoy en el ciclo hasta generar una soluci贸n vecina que satisfaga las restricciones
			while (constraintOK == false)
			{
